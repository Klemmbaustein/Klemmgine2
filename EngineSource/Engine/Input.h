...
namespace engine::input
{
	...
	enum class Key
	{
		...
		CTRL = TO_KEYCODE(Key_Scancode::SCANCODE_LCTRL),
		SHIFT = TO_KEYCODE(Key_Scancode::SCANCODE_LSHIFT),
		ALT = TO_KEYCODE(Key_Scancode::SCANCODE_LALT),
		GUI = TO_KEYCODE(Key_Scancode::SCANCODE_LGUI),
