...
foreach(NET_SDK ${NET_SDK_LIST})
	...
	elseif(${SDK_NAME} VERSION_GREATER "${LATEST_SDK_VERSION}" AND NOT ${SDK_NAME} MATCHES "preview")
		set(LATEST_SDK_VERSION "${SDK_NAME}")
		set(LATEST_SDK_PATH "${SDK_LOCATION}/${SDK_NAME}")
	endif()
endforeach()
...
foreach(VER ${PACK_VERSIONS})
	...
	if ("${VERSION_NAME}" VERSION_GREATER "${LATEST_PACK_PATH}")
		set(LATEST_PACK_PATH "${VERSION_NAME}")
	endif()
endforeach()
...
set(NET_SDK_BINARY_DIR "${PACK_PATH}/${LATEST_PACK_PATH}/runtimes/${NET_RUNTIME_ID}/native")
